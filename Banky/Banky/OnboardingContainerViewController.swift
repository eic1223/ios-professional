...
//  Banky
//
//  Created by Dane's macbook pro on 2022/04/08.
//
...
class OnboardingContainerViewController: UIViewController {
    ...
    override init(nibName nibNameOrNil: String?, bundle nibBundleOrNil: Bundle?) {
        ...
        let page1 = OnboardingViewController(heroImageName: "delorean", titleText: "Banky is fasterm, easier to use, and has a brand new look and feel that will make you feel like you are back in 1999.")
    ...
    private func setup() {
        ...
        // child VC를 parant VC의 lifecycle에 맞추게 하는 부분
