...
extension LoginViewController {
    private func style() {
        ...
        subtitleLabel.text = "Your premimum source for all things banking!"
...
extension LoginViewController {
    ...
    private func login() {
        ...
        if username == "Dane" && password == "1234" {
...
extension LoginViewController {
    ...
    private func animate() {
        ...
        let animator4 = UIViewPropertyAnimator(duration: duration*4, curve: .easeInOut) {
